...
| `backend` | Obadiyah Mutuku | Backend Engineer | Microservices, data processing pipeline, and business logic. |
| `database` | Gladys Mutta | Database Engineer | PostgreSQL schema design, optimization, and TimescaleDB integration. |
| `api` | Ntsako Baloyi | API Architect | RESTful & WebSocket API definitions, Gateway routing, and Auth. |
| `documentation` | Boniface Ndegwa | Product Manager / Technical Writer | Project documentation, user guides, team charter, and specifications. |
